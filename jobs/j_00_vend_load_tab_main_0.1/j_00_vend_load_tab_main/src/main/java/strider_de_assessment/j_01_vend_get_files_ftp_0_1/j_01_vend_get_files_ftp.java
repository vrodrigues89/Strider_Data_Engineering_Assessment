...
package strider_de_assessment.j_01_vend_get_files_ftp_0_1;
...
/**
 * Job: j_01_vend_get_files_ftp Purpose: Job to get vendor files by FTP<br>
 * Description: Job to get vendor files by FTP <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class j_01_vend_get_files_ftp implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "j_01_vend_get_files_ftp";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				j_01_vend_get_files_ftp.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(j_01_vend_get_files_ftp.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
//check if the host is in the excludes for proxy
	...
	final String decryptedPassword_tFTPConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:hbXOI/UNmomkzK0SEvQyas17SCRVlD4OXWfZCmsnO3k=");
 ...
 */
    ...
    public static void main(String[] args){
        final j_01_vend_get_files_ftp j_01_vend_get_files_ftpClass = new j_01_vend_get_files_ftp();

        int exitCode = j_01_vend_get_files_ftpClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = j_01_vend_get_files_ftp.class.getClassLoader().getResourceAsStream("strider_de_assessment/j_01_vend_get_files_ftp_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = j_01_vend_get_files_ftp.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : j_01_vend_get_files_ftp");
        }
...
/************************************************************************************************
 *     60375 characters generated by Talend Open Studio for Data Integration 
 *     on the 15 de setembro de 2022 20:42:33 BRT
 ************************************************************************************************/