...
package strider_de_assessment.j_00_vend_load_tab_main_0_1;
...
/**
 * Job: j_00_vend_load_tab_main Purpose: Job responsible for orchestrating all vendor jobs<br>
 * Description: Job responsible for orchestrating all vendor jobs <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class j_00_vend_load_tab_main implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "j_00_vend_load_tab_main";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				j_00_vend_load_tab_main.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(j_00_vend_load_tab_main.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		strider_de_assessment.j_01_vend_get_files_ftp_0_1.j_01_vend_get_files_ftp childJob_tRunJob_1 = new strider_de_assessment.j_01_vend_get_files_ftp_0_1.j_01_vend_get_files_ftp();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		strider_de_assessment.j_02_vend_load_authors_0_1.j_02_vend_load_authors childJob_tRunJob_2 = new strider_de_assessment.j_02_vend_load_authors_0_1.j_02_vend_load_authors();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		strider_de_assessment.j_03_vend_load_books_0_1.j_03_vend_load_books childJob_tRunJob_3 = new strider_de_assessment.j_03_vend_load_books_0_1.j_03_vend_load_books();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		strider_de_assessment.j_04_vend_load_reviews_0_1.j_04_vend_load_reviews childJob_tRunJob_4 = new strider_de_assessment.j_04_vend_load_reviews_0_1.j_04_vend_load_reviews();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		strider_de_assessment.j_05_vend_move_proc_files_ftp_0_1.j_05_vend_move_proc_files_ftp childJob_tRunJob_5 = new strider_de_assessment.j_05_vend_move_proc_files_ftp_0_1.j_05_vend_move_proc_files_ftp();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final j_00_vend_load_tab_main j_00_vend_load_tab_mainClass = new j_00_vend_load_tab_main();

        int exitCode = j_00_vend_load_tab_mainClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = j_00_vend_load_tab_main.class.getClassLoader().getResourceAsStream("strider_de_assessment/j_00_vend_load_tab_main_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = j_00_vend_load_tab_main.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : j_00_vend_load_tab_main");
        }
