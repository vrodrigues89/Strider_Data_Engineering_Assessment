...
package strider_de_assessment.j_03_vend_load_books_0_1;
...
/**
 * Job: j_03_vend_load_books Purpose: Load data into books table<br>
 * Description: Read vendor authors JSON file and load it to books in MariaDB <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class j_03_vend_load_books implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "j_03_vend_load_books";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				j_03_vend_load_books.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(j_03_vend_load_books.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class output2Struct implements routines.system.IPersistableRow<output2Struct> {
    final static byte[] commonByteArrayLock_STRIDER_DE_ASSESSMENT_j_03_vend_load_books = new byte[0];
    static byte[] commonByteArray_STRIDER_DE_ASSESSMENT_j_03_vend_load_books = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_STRIDER_DE_ASSESSMENT_j_03_vend_load_books.length) {
				if(length < 1024 && commonByteArray_STRIDER_DE_ASSESSMENT_j_03_vend_load_books.length == 0) {
   					commonByteArray_STRIDER_DE_ASSESSMENT_j_03_vend_load_books = new byte[1024];
				} else {
   					commonByteArray_STRIDER_DE_ASSESSMENT_j_03_vend_load_books = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_STRIDER_DE_ASSESSMENT_j_03_vend_load_books, 0, length);
			strReturn = new String(commonByteArray_STRIDER_DE_ASSESSMENT_j_03_vend_load_books, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_STRIDER_DE_ASSESSMENT_j_03_vend_load_books, 0, length);
			strReturn = new String(commonByteArray_STRIDER_DE_ASSESSMENT_j_03_vend_load_books, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_STRIDER_DE_ASSESSMENT_j_03_vend_load_books) {
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:3meiD8CMFW+it5RAl3Eg/yvnjyTN92Cc9HZeL8moIJA=");
 ...
 */
    ...
    public static void main(String[] args){
        final j_03_vend_load_books j_03_vend_load_booksClass = new j_03_vend_load_books();

        int exitCode = j_03_vend_load_booksClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = j_03_vend_load_books.class.getClassLoader().getResourceAsStream("strider_de_assessment/j_03_vend_load_books_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = j_03_vend_load_books.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : j_03_vend_load_books");
        }
...
/************************************************************************************************
 *     225895 characters generated by Talend Open Studio for Data Integration 
