...
package strider_de_assessment.j_03_internal_load_users_0_1;
...
/**
 * Job: j_03_internal_load_users Purpose: Load data into users table<br>
 * Description: Read vendor users CSV file and load it to users in MariaDB <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class j_03_internal_load_users implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "j_03_internal_load_users";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				j_03_internal_load_users.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(j_03_internal_load_users.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class output2Struct implements routines.system.IPersistableRow<output2Struct> {
    final static byte[] commonByteArrayLock_STRIDER_DE_ASSESSMENT_j_03_internal_load_users = new byte[0];
    static byte[] commonByteArray_STRIDER_DE_ASSESSMENT_j_03_internal_load_users = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_STRIDER_DE_ASSESSMENT_j_03_internal_load_users.length) {
				if(length < 1024 && commonByteArray_STRIDER_DE_ASSESSMENT_j_03_internal_load_users.length == 0) {
   					commonByteArray_STRIDER_DE_ASSESSMENT_j_03_internal_load_users = new byte[1024];
				} else {
   					commonByteArray_STRIDER_DE_ASSESSMENT_j_03_internal_load_users = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_STRIDER_DE_ASSESSMENT_j_03_internal_load_users, 0, length);
			strReturn = new String(commonByteArray_STRIDER_DE_ASSESSMENT_j_03_internal_load_users, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_STRIDER_DE_ASSESSMENT_j_03_internal_load_users, 0, length);
			strReturn = new String(commonByteArray_STRIDER_DE_ASSESSMENT_j_03_internal_load_users, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_STRIDER_DE_ASSESSMENT_j_03_internal_load_users) {
...
int count_tDBOutput_1=0;
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1 + "`(`id` INT(0)  ,`first_name` VARCHAR(0)  ,`last_name` VARCHAR(0)  ,`email` VARCHAR(0)  ,primary key(`email`))");
                                    }
                                }
	    java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM `" + "users" + "` WHERE `email` = ?");
	    resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO `" + "users" + "` (`id`,`first_name`,`last_name`,`email`) VALUES (?,?,?,?)";
	        
	    java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
	    resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
	    String update_tDBOutput_1 = "UPDATE `" + "users" + "` SET `id` = ?,`first_name` = ?,`last_name` = ? WHERE `email` = ?";
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "/talendinfra/data/staging/users.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("/talendinfra/data/staging/users.csv", "UTF-8",";","\n",true,1,0,
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",e.getMessage());
				...
				int columnIndexWithD_tFileInputDelimited_1 = 0;
					...
					columnIndexWithD_tFileInputDelimited_1 = 0;
							...
							row2.first_name = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 1;
					
							row2.last_name = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 2;
					
							row2.email = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
...
// # Output table : 'out'
out_tmp.first_name = row2.first_name.equals("") ? null : row2.first_name ;
out_tmp.last_name = row2.last_name.equals("") ? null : row2.last_name ;
out_tmp.email = row2.email ;
out = out_tmp;
// ###############################
       ...
       Long crcComputedValuetAddCRCRow_2 = null;
                StringBuilder strBuffer_tAddCRCRow_2 = new StringBuilder();
                       strBuffer_tAddCRCRow_2.append(
				                ...
				                String.valueOf(out.first_name)			
								
				);
                		
                       strBuffer_tAddCRCRow_2.append(
				
				                String.valueOf(out.last_name)			
                    ...
                    crcComputedValuetAddCRCRow_2 = new Long(crc32tAddCRCRow_2.getValue());
                                row3.first_name=out.first_name;
                                row3.last_name=out.last_name;
                                row3.email=out.email;
 							...
 							row6Struct row6ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
				           		...
				           		if(tHash_Lookup_row6 != null && tHash_Lookup_row6.getCount(row6HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row6' and it contains more one result from keys :  row6.email = '" + row6HashKey.email + "'");
								} // G 071
...
Var.v_id = Numeric.sequence("u1",(Integer)globalMap.get("MaxID"),1) ;
...
output2_tmp.first_name = row3.first_name ;
output2_tmp.last_name = row3.last_name ;
output2_tmp.email = row3.email ;
output2 = output2_tmp;
...
if(output2 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(output2.email == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, output2.email);
}
...
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
                        ...
                        if(output2.first_name == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, output2.first_name);
}

                        if(output2.last_name == null) {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(3, output2.last_name);
}

                        if(output2.email == null) {
pstmtUpdate_tDBOutput_1.setNull(4 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4 + count_tDBOutput_1, output2.email);
}
...
} else {pstmtInsert_tDBOutput_1.setString(2, output2.first_name);
}

                        if(output2.last_name == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(3, output2.last_name);
}

                        if(output2.email == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(4, output2.email);
}
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)("/talendinfra/data/staging/users.csv") instanceof java.io.InputStream)){
...
System.out.println("Inserted Rows into users table:" + ((Integer)globalMap.get("tDBOutput_1_NB_LINE_INSERTED")));
System.out.println("Updated Rows into users table:" + ((Integer)globalMap.get("tDBOutput_1_NB_LINE_UPDATED")));
System.out.println("Rejected Rows into users table:" + ((Integer)globalMap.get("tDBOutput_1_NB_LINE_REJECTED")));
 ...
 */
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
        	...
        	row5.first_name = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 3) {
								row5.last_name = null;
							} else {
	                         		
        	row5.last_name = routines.system.JDBCUtil.getString(rs_tDBInput_3, 3, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 4) {
								row5.email = null;
							} else {
	                         		
        	row5.email = routines.system.JDBCUtil.getString(rs_tDBInput_3, 4, true);
		                    }
       ...
       Long crcComputedValuetAddCRCRow_1 = null;
                StringBuilder strBuffer_tAddCRCRow_1 = new StringBuilder();
                       strBuffer_tAddCRCRow_1.append(
				                ...
				                String.valueOf(row5.first_name)			
								
				);
                		
                       strBuffer_tAddCRCRow_1.append(
				
				                String.valueOf(row5.last_name)			
                    ...
                    crcComputedValuetAddCRCRow_1 = new Long(crc32tAddCRCRow_1.getValue());
                                row6.id=row5.id;
                                row6.first_name=row5.first_name;
                                row6.last_name=row5.last_name;
 ...
 */
	...
	currentComponent="tAdvancedHash_row6";
				...
				row6_HashRow.first_name = row6.first_name;
				
				row6_HashRow.last_name = row6.last_name;
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:+9/aQLE66V/7piiaqXl18Adp550P2aPUspeWEybRXUI=");
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
		    ...
		    String dbquery_tDBInput_2 = "select nvl(max(id),0)+1 as MaxID from users";
...
row8Struct row8 = new row8Struct();
  ...
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add("*users*.csv");  
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("/talendinfra/data/staging/users.csv")).getAbsolutePath().replace("\\","/");
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.first_name = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.last_name = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
output_tmp.first_name = row1.first_name ;
output_tmp.last_name = row1.last_name ;
output_tmp.email = row1.email ;
output = output_tmp;
} // closing filter/reject
// ###############################
...
if(output.email == null){
	finder_tUniqRow_1.email = null;
}else{
	finder_tUniqRow_1.email = output.email.toLowerCase();
}	
...
if(output.email == null){
	new_tUniqRow_1.email = null;
}else{
	new_tUniqRow_1.email = output.email.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row8 == null){ 
	
	row8 = new row8Struct();
}row8.first_name = output.first_name;			row8.last_name = output.last_name;			row8.email = output.email;					
 ...
 */
    ...
    public static void main(String[] args){
        final j_03_internal_load_users j_03_internal_load_usersClass = new j_03_internal_load_users();

        int exitCode = j_03_internal_load_usersClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = j_03_internal_load_users.class.getClassLoader().getResourceAsStream("strider_de_assessment/j_03_internal_load_users_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = j_03_internal_load_users.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : j_03_internal_load_users");
        }
...
/************************************************************************************************
 *     238431 characters generated by Talend Open Studio for Data Integration 
 *     on the 13 de setembro de 2022 21:09:48 BRT
 ************************************************************************************************/