...
package strider_de_assessment.j_00_internal_load_tables_orchestrator_0_1;
...
/**
 * Job: j_00_internal_load_tables_orchestrator Purpose: Job responsible for orchestrating all internal jobs<br>
 * Description: Job responsible for orchestrating all internal jobs <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class j_00_internal_load_tables_orchestrator implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "j_00_internal_load_tables_orchestrator";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				j_00_internal_load_tables_orchestrator.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(j_00_internal_load_tables_orchestrator.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		strider_de_assessment.j_01_internal_load_movies_0_1.j_01_internal_load_movies childJob_tRunJob_2 = new strider_de_assessment.j_01_internal_load_movies_0_1.j_01_internal_load_movies();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		strider_de_assessment.j_02_internal_load_streams_0_1.j_02_internal_load_streams childJob_tRunJob_3 = new strider_de_assessment.j_02_internal_load_streams_0_1.j_02_internal_load_streams();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		strider_de_assessment.j_03_internal_load_users_0_1.j_03_internal_load_users childJob_tRunJob_4 = new strider_de_assessment.j_03_internal_load_users_0_1.j_03_internal_load_users();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		strider_de_assessment.j_04_internal_move_processed_files_0_1.j_04_internal_move_processed_files childJob_tRunJob_1 = new strider_de_assessment.j_04_internal_move_processed_files_0_1.j_04_internal_move_processed_files();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final j_00_internal_load_tables_orchestrator j_00_internal_load_tables_orchestratorClass = new j_00_internal_load_tables_orchestrator();

        int exitCode = j_00_internal_load_tables_orchestratorClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = j_00_internal_load_tables_orchestrator.class.getClassLoader().getResourceAsStream("strider_de_assessment/j_00_internal_load_tables_orchestrator_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = j_00_internal_load_tables_orchestrator.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : j_00_internal_load_tables_orchestrator");
        }
...
/************************************************************************************************
 *     53776 characters generated by Talend Open Studio for Data Integration 
