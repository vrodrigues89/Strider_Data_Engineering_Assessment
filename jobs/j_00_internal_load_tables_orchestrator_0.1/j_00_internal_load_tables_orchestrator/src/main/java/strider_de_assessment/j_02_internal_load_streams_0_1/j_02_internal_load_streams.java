...
package strider_de_assessment.j_02_internal_load_streams_0_1;
...
/**
 * Job: j_02_internal_load_streams Purpose: Load data into streams table<br>
 * Description: Read vendor streams CSV file and load it to streams in MariaDB <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class j_02_internal_load_streams implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "j_02_internal_load_streams";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				j_02_internal_load_streams.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(j_02_internal_load_streams.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class output2Struct implements routines.system.IPersistableRow<output2Struct> {
    final static byte[] commonByteArrayLock_STRIDER_DE_ASSESSMENT_j_02_internal_load_streams = new byte[0];
    static byte[] commonByteArray_STRIDER_DE_ASSESSMENT_j_02_internal_load_streams = new byte[0];
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.movie_title == null) ? 0 : this.movie_title.hashCode());
					
						result = prime * result + ((this.user_email == null) ? 0 : this.user_email.hashCode());
					
						result = prime * result + ((this.start_at == null) ? 0 : this.start_at.hashCode());
					
						result = prime * result + ((this.end_at == null) ? 0 : this.end_at.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final output2Struct other = (output2Struct) obj;
						...
						} else if (!this.movie_title.equals(other.movie_title))
						...
						if (this.start_at == null) {
							if (other.start_at != null)
								return false;
						
						} else if (!this.start_at.equals(other.start_at))
						
							return false;
					
						if (this.end_at == null) {
							if (other.end_at != null)
								return false;
						
						} else if (!this.end_at.equals(other.end_at))
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_STRIDER_DE_ASSESSMENT_j_02_internal_load_streams.length) {
				if(length < 1024 && commonByteArray_STRIDER_DE_ASSESSMENT_j_02_internal_load_streams.length == 0) {
   					commonByteArray_STRIDER_DE_ASSESSMENT_j_02_internal_load_streams = new byte[1024];
				} else {
   					commonByteArray_STRIDER_DE_ASSESSMENT_j_02_internal_load_streams = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_STRIDER_DE_ASSESSMENT_j_02_internal_load_streams, 0, length);
			strReturn = new String(commonByteArray_STRIDER_DE_ASSESSMENT_j_02_internal_load_streams, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_STRIDER_DE_ASSESSMENT_j_02_internal_load_streams, 0, length);
			strReturn = new String(commonByteArray_STRIDER_DE_ASSESSMENT_j_02_internal_load_streams, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_STRIDER_DE_ASSESSMENT_j_02_internal_load_streams) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.movie_title = readString(dis);
					
					this.user_email = readString(dis);
					
					this.size_mb = readString(dis);
					
					this.start_at = readString(dis);
					
					this.end_at = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.movie_title,dos);
					
					// String
				
						writeString(this.user_email,dos);
					
					// String
				
						writeString(this.size_mb,dos);
					
					// String
				
						writeString(this.start_at,dos);
					
					// String
				
						writeString(this.end_at,dos);
    ...
    public String toString() {
		...
		sb.append(",size_mb="+size_mb);
		sb.append(",start_at="+start_at);
		sb.append(",end_at="+end_at);
	    sb.append("]");
    ...
    public int compareTo(output2Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.movie_title, other.movie_title);
						if(returnValue != 0) {
							return returnValue;
						}

					
						returnValue = checkNullsAndCompare(this.user_email, other.user_email);
						if(returnValue != 0) {
							return returnValue;
						}

					
						returnValue = checkNullsAndCompare(this.start_at, other.start_at);
						if(returnValue != 0) {
							return returnValue;
						}

					
						returnValue = checkNullsAndCompare(this.end_at, other.end_at);
						if(returnValue != 0) {
							return returnValue;
						}
...
String tableName_tDBOutput_1 = "streams";
...
int count_tDBOutput_1=0;
                                ...
                                while(rsTable_tDBOutput_1.next()) {
                                    ...
                                    if(table_tDBOutput_1.equalsIgnoreCase("streams")) {
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1 + "`(`id` INT(0)  ,`movie_title` VARCHAR(0)  ,`user_email` VARCHAR(0)  ,`size_mb` VARCHAR(0)  ,`start_at` VARCHAR(0)  ,`end_at` VARCHAR(0)  ,primary key(`movie_title`,`user_email`,`start_at`,`end_at`))");
                                    }
                                }
	    java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM `" + "streams" + "` WHERE `movie_title` = ? AND `user_email` = ? AND `start_at` = ? AND `end_at` = ?");
	    resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO `" + "streams" + "` (`id`,`movie_title`,`user_email`,`size_mb`,`start_at`,`end_at`) VALUES (?,?,?,?,?,?)";
	        
	    java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
	    resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
	    String update_tDBOutput_1 = "UPDATE `" + "streams" + "` SET `id` = ?,`size_mb` = ? WHERE `movie_title` = ? AND `user_email` = ? AND `start_at` = ? AND `end_at` = ?";
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "/talendinfra/data/staging/streams.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("/talendinfra/data/staging/streams.csv", "UTF-8",";","\n",true,1,0,
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",e.getMessage());
				...
				int columnIndexWithD_tFileInputDelimited_1 = 0;
					...
					columnIndexWithD_tFileInputDelimited_1 = 0;
							...
							row2.movie_title = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 1;
					
							row2.user_email = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 2;
					
							row2.size_mb = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 3;
					
							row2.start_at = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 4;
					
							row2.end_at = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
...
// # Output table : 'out'
out_tmp.movie_title = row2.movie_title ;
out_tmp.user_email = row2.user_email ;
out_tmp.size_mb = row2.size_mb.equals("") ? null : row2.size_mb ;
out_tmp.start_at = row2.start_at.equals("") ? null : row2.start_at ;
out_tmp.end_at = row2.end_at.equals("") ? null : row2.end_at ;
out = out_tmp;
// ###############################
       ...
       Long crcComputedValuetAddCRCRow_2 = null;
                StringBuilder strBuffer_tAddCRCRow_2 = new StringBuilder();
                    ...
                    crcComputedValuetAddCRCRow_2 = new Long(crc32tAddCRCRow_2.getValue());
                                row3.movie_title=out.movie_title;
                                row3.user_email=out.user_email;
                                row3.size_mb=out.size_mb;
                                row3.start_at=out.start_at;
                                row3.end_at=out.end_at;
 					    ...
 					    boolean forceLooprow6 = false;
 							...
 							row6Struct row6ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		    ...
                        		    		    row6HashKey.movie_title = row3.movie_title ;
                        		    		
                        		    		    row6HashKey.user_email = row3.user_email ;
                        		    		
                        		    		    row6HashKey.start_at = row3.start_at ;
                        		    		
                        		    		    row6HashKey.end_at = row3.end_at ;
				           		...
				           		if(tHash_Lookup_row6 != null && tHash_Lookup_row6.getCount(row6HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row6' and it contains more one result from keys :  row6.movie_title = '" + row6HashKey.movie_title + "', row6.user_email = '" + row6HashKey.user_email + "', row6.start_at = '" + row6HashKey.start_at + "', row6.end_at = '" + row6HashKey.end_at + "'");
								} // G 071
...
output2_tmp.movie_title = row3.movie_title ;
output2_tmp.user_email = row3.user_email ;
output2_tmp.size_mb = row3.size_mb ;
output2_tmp.start_at = row3.start_at ;
output2_tmp.end_at = row3.end_at ;
output2 = output2_tmp;
...
if(output2 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(output2.movie_title == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, output2.movie_title);
}

                    if(output2.user_email == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, output2.user_email);
}

                    if(output2.start_at == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, output2.start_at);
}

                    if(output2.end_at == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, output2.end_at);
}
...
} else {pstmtUpdate_tDBOutput_1.setString(2, output2.size_mb);
}

                        if(output2.movie_title == null) {
pstmtUpdate_tDBOutput_1.setNull(3 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(3 + count_tDBOutput_1, output2.movie_title);
}

                        if(output2.user_email == null) {
pstmtUpdate_tDBOutput_1.setNull(4 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4 + count_tDBOutput_1, output2.user_email);
}

                        if(output2.start_at == null) {
pstmtUpdate_tDBOutput_1.setNull(5 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(5 + count_tDBOutput_1, output2.start_at);
}

                        if(output2.end_at == null) {
pstmtUpdate_tDBOutput_1.setNull(6 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(6 + count_tDBOutput_1, output2.end_at);
}
...
} else {pstmtInsert_tDBOutput_1.setString(2, output2.movie_title);
}

                        if(output2.user_email == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(3, output2.user_email);
}

                        if(output2.size_mb == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(4, output2.size_mb);
}

                        if(output2.start_at == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(5, output2.start_at);
}

                        if(output2.end_at == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(6, output2.end_at);
}
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)("/talendinfra/data/staging/streams.csv") instanceof java.io.InputStream)){
...
System.out.println("Inserted Rows into streams table:" + ((Integer)globalMap.get("tDBOutput_1_NB_LINE_INSERTED")));
System.out.println("Updated Rows into streams table:" + ((Integer)globalMap.get("tDBOutput_1_NB_LINE_UPDATED")));
System.out.println("Rejected Rows into streams table:" + ((Integer)globalMap.get("tDBOutput_1_NB_LINE_REJECTED")));
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.size_mb = readString(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.size_mb = readString(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
					...
					writeInteger(this.id, dos, oos);
						...
						writeString(this.size_mb, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					writeInteger(this.id, dos, objectOut);
						...
						writeString(this.size_mb, dos, objectOut);
            ...
            if(rs_tDBInput_3.wasNull()){
                    row5.id = null;
							...
							if(colQtyInRs_tDBInput_3 < 2) {
								row5.movie_title = null;
							} else {
	                         		
        	row5.movie_title = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 3) {
								row5.user_email = null;
							} else {
	                         		
        	row5.user_email = routines.system.JDBCUtil.getString(rs_tDBInput_3, 3, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 4) {
								row5.size_mb = null;
							} else {
	                         		
        	row5.size_mb = routines.system.JDBCUtil.getString(rs_tDBInput_3, 4, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 5) {
								row5.start_at = null;
							} else {
	                         		
        	row5.start_at = routines.system.JDBCUtil.getString(rs_tDBInput_3, 5, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 6) {
								row5.end_at = null;
							} else {
	                         		
        	row5.end_at = routines.system.JDBCUtil.getString(rs_tDBInput_3, 6, true);
		                    }
       ...
       Long crcComputedValuetAddCRCRow_1 = null;
                StringBuilder strBuffer_tAddCRCRow_1 = new StringBuilder();
                    ...
                    crcComputedValuetAddCRCRow_1 = new Long(crc32tAddCRCRow_1.getValue());
                                row6.id=row5.id;
                                row6.movie_title=row5.movie_title;
                                row6.user_email=row5.user_email;
                                row6.size_mb=row5.size_mb;
                                row6.start_at=row5.start_at;
                                row6.end_at=row5.end_at;
 ...
 */
	...
	currentComponent="tAdvancedHash_row6";
				...
				row6_HashRow.user_email = row6.user_email;
				
				row6_HashRow.size_mb = row6.size_mb;
				
				row6_HashRow.start_at = row6.start_at;
				
				row6_HashRow.end_at = row6.end_at;
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:wBd79YU4dGgaBjUXIXtv04YMY1ZCZDk9puQmwRAjcIY=");
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
		    ...
		    String dbquery_tDBInput_2 = "select nvl(max(id),0)+1 as MaxID from streams";
...
+"0) DEFAULT NULL,\n  `size_mb` varchar(200) DEFAULT NULL,\n  `start_at` datetime DEFAULT NULL,\n  `end_at` datetime DEFAU"
+"LT NULL,\n  PRIMARY KEY (`movie_title`,`user_email`,`start_at`,`end_at`)\n) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;\n";
...
outputStruct output = new outputStruct();
  ...
  String directory_tFileList_1 = "C:/talendinfra/data/source/internal/";
  final java.util.List<String> maskList_tFileList_1 = new java.util.ArrayList<String>();
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add("*streams*.csv");  
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("/talendinfra/data/staging/streams.csv")).getAbsolutePath().replace("\\","/");
                    ...
                    if(directory_tFileOutputDelimited_1 != null && directory_tFileOutputDelimited_1.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, false),"UTF-8"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        outtFileOutputDelimited_1.write("movie_title");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("user_email");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("size_mb");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("start_at");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("end_at");
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",e.getMessage());
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row1.movie_title = null;
					
							row1.user_email = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.movie_title = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.user_email = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.size_mb = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.start_at = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.end_at = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
row1.movie_title != null || row1.user_email != null

 ) {
output_tmp.movie_title = row1.movie_title ;
output_tmp.user_email = row1.user_email ;
output_tmp.size_mb = row1.size_mb ;
output_tmp.start_at = row1.start_at == null || row1.start_at == "" ? null :
TalendDate.formatDate("yyyy-MM-dd HH:mm:ss",TalendDate.parseDate("yyyy-MM-dd'T'HH:mm:ss.SSSZ",row1.start_at)) ;
output_tmp.end_at = row1.end_at == null || row1.end_at == "" ? null :
TalendDate.formatDate("yyyy-MM-dd HH:mm:ss",TalendDate.parseDate("yyyy-MM-dd'T'HH:mm:ss.SSSZ",row1.end_at)) ;
output = output_tmp;
} // closing filter/reject
// ###############################
...
if(output != null) { 
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                            if(output.movie_title != null) {
                        sb_tFileOutputDelimited_1.append(
                            output.movie_title
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(output.user_email != null) {
                        sb_tFileOutputDelimited_1.append(
                            output.user_email
                        );
                            }
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(output.start_at != null) {
                        sb_tFileOutputDelimited_1.append(
                            output.start_at
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(output.end_at != null) {
                        sb_tFileOutputDelimited_1.append(
                            output.end_at
                        );
                            }
 ...
 */
    ...
    public static void main(String[] args){
        final j_02_internal_load_streams j_02_internal_load_streamsClass = new j_02_internal_load_streams();

        int exitCode = j_02_internal_load_streamsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = j_02_internal_load_streams.class.getClassLoader().getResourceAsStream("strider_de_assessment/j_02_internal_load_streams_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = j_02_internal_load_streams.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : j_02_internal_load_streams");
        }
...
/************************************************************************************************
 *     246031 characters generated by Talend Open Studio for Data Integration 
 *     on the 12 de setembro de 2022 18:57:38 BRT
 ************************************************************************************************/