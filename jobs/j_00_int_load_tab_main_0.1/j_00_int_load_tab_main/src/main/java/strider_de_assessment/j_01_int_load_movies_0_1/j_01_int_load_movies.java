...
package strider_de_assessment.j_01_int_load_movies_0_1;
...
/**
 * Job: j_01_int_load_movies Purpose: Load data into movies table<br>
 * Description: Read vendor movies CSV file and load it to movies in MariaDB <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class j_01_int_load_movies implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "j_01_int_load_movies";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				j_01_int_load_movies.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(j_01_int_load_movies.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class output2Struct implements routines.system.IPersistableRow<output2Struct> {
    final static byte[] commonByteArrayLock_STRIDER_DE_ASSESSMENT_j_01_int_load_movies = new byte[0];
    static byte[] commonByteArray_STRIDER_DE_ASSESSMENT_j_01_int_load_movies = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_STRIDER_DE_ASSESSMENT_j_01_int_load_movies.length) {
				if(length < 1024 && commonByteArray_STRIDER_DE_ASSESSMENT_j_01_int_load_movies.length == 0) {
   					commonByteArray_STRIDER_DE_ASSESSMENT_j_01_int_load_movies = new byte[1024];
				} else {
   					commonByteArray_STRIDER_DE_ASSESSMENT_j_01_int_load_movies = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_STRIDER_DE_ASSESSMENT_j_01_int_load_movies, 0, length);
			strReturn = new String(commonByteArray_STRIDER_DE_ASSESSMENT_j_01_int_load_movies, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_STRIDER_DE_ASSESSMENT_j_01_int_load_movies, 0, length);
			strReturn = new String(commonByteArray_STRIDER_DE_ASSESSMENT_j_01_int_load_movies, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_STRIDER_DE_ASSESSMENT_j_01_int_load_movies) {
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:jjrNbdU6kdcQUKtXfXb1cMtpxRDHji/WxxQVZtZDMnw=");
 ...
 */
    ...
    public static void main(String[] args){
        final j_01_int_load_movies j_01_int_load_moviesClass = new j_01_int_load_movies();

        int exitCode = j_01_int_load_moviesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = j_01_int_load_movies.class.getClassLoader().getResourceAsStream("strider_de_assessment/j_01_int_load_movies_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = j_01_int_load_movies.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : j_01_int_load_movies");
        }
...
/************************************************************************************************
 *     244432 characters generated by Talend Open Studio for Data Integration 
 *     on the 14 de setembro de 2022 21:23:54 BRT
 ************************************************************************************************/