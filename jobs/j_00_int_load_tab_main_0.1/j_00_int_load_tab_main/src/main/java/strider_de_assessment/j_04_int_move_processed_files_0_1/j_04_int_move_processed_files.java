...
package strider_de_assessment.j_04_int_move_processed_files_0_1;
...
/**
 * Job: j_04_int_move_processed_files Purpose: Job to move processed internal files<br>
 * Description: Job to move processed internal files <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class j_04_int_move_processed_files implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "j_04_int_move_processed_files";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				j_04_int_move_processed_files.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(j_04_int_move_processed_files.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final j_04_int_move_processed_files j_04_int_move_processed_filesClass = new j_04_int_move_processed_files();

        int exitCode = j_04_int_move_processed_filesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = j_04_int_move_processed_files.class.getClassLoader().getResourceAsStream("strider_de_assessment/j_04_int_move_processed_files_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = j_04_int_move_processed_files.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : j_04_int_move_processed_files");
        }
...
/************************************************************************************************
 *     38321 characters generated by Talend Open Studio for Data Integration 
