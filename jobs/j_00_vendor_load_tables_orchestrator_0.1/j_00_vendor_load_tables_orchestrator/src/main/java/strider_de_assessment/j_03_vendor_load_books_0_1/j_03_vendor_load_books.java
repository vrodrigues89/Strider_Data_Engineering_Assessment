...
package strider_de_assessment.j_03_vendor_load_books_0_1;
...
/**
 * Job: j_03_vendor_load_books Purpose: Load data into books table<br>
 * Description: Read vendor authors JSON file and load it to books in MariaDB <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class j_03_vendor_load_books implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "j_03_vendor_load_books";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				j_03_vendor_load_books.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(j_03_vendor_load_books.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class output2Struct implements routines.system.IPersistableRow<output2Struct> {
    final static byte[] commonByteArrayLock_STRIDER_DE_ASSESSMENT_j_03_vendor_load_books = new byte[0];
    static byte[] commonByteArray_STRIDER_DE_ASSESSMENT_j_03_vendor_load_books = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_STRIDER_DE_ASSESSMENT_j_03_vendor_load_books.length) {
				if(length < 1024 && commonByteArray_STRIDER_DE_ASSESSMENT_j_03_vendor_load_books.length == 0) {
   					commonByteArray_STRIDER_DE_ASSESSMENT_j_03_vendor_load_books = new byte[1024];
				} else {
   					commonByteArray_STRIDER_DE_ASSESSMENT_j_03_vendor_load_books = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_STRIDER_DE_ASSESSMENT_j_03_vendor_load_books, 0, length);
			strReturn = new String(commonByteArray_STRIDER_DE_ASSESSMENT_j_03_vendor_load_books, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_STRIDER_DE_ASSESSMENT_j_03_vendor_load_books, 0, length);
			strReturn = new String(commonByteArray_STRIDER_DE_ASSESSMENT_j_03_vendor_load_books, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_STRIDER_DE_ASSESSMENT_j_03_vendor_load_books) {
...
String tableName_tDBOutput_1 = "books";
...
int count_tDBOutput_1=0;
                                ...
                                while(rsTable_tDBOutput_1.next()) {
                                    ...
                                    if(table_tDBOutput_1.equalsIgnoreCase("books")) {
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1 + "`(`id` INT(0)  ,`name` VARCHAR(0)  ,`pages` INT(0)  ,`author` VARCHAR(0)  ,`publisher` VARCHAR(0)  ,primary key(`name`))");
                                    }
                                }
	    java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM `" + "books" + "` WHERE `name` = ?");
	    resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO `" + "books" + "` (`id`,`name`,`pages`,`author`,`publisher`) VALUES (?,?,?,?,?)";
	        
	    java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
	    resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
	    String update_tDBOutput_1 = "UPDATE `" + "books" + "` SET `id` = ?,`pages` = ?,`author` = ?,`publisher` = ? WHERE `name` = ?";
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "/talendinfra/data/staging/books.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("/talendinfra/data/staging/books.csv", "UTF-8",";","\n",true,1,0,
					...
					columnIndexWithD_tFileInputDelimited_1 = 1;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row2.pages = ParserUtils.parseTo_Integer(temp);
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"pages", "row2", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 2;
							...
							row2.author = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 3;
					
							row2.publisher = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
       ...
       Long crcComputedValuetAddCRCRow_1 = null;
                StringBuilder strBuffer_tAddCRCRow_1 = new StringBuilder();
                       strBuffer_tAddCRCRow_1.append(
				                ...
				                String.valueOf(row2.pages)			
								
				);
                		
                       strBuffer_tAddCRCRow_1.append(
				
				                String.valueOf(row2.author)			
								
				);
                		
                       strBuffer_tAddCRCRow_1.append(
				
				                String.valueOf(row2.publisher)			
                    ...
                    crcComputedValuetAddCRCRow_1 = new Long(crc32tAddCRCRow_1.getValue());
                                row3.name=row2.name;
                                row3.pages=row2.pages;
                                row3.author=row2.author;
                                row3.publisher=row2.publisher;
                            row3.CRC=crcComputedValuetAddCRCRow_1;
...
Var.v_id = Numeric.sequence("b1",(Integer)globalMap.get("MaxID"),1) ;
...
output2_tmp.author = row3.author;
output2_tmp.publisher = row3.publisher;
output2 = output2_tmp;
...
} else {pstmtUpdate_tDBOutput_1.setString(3, output2.author);
}

                        if(output2.publisher == null) {
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4, output2.publisher);
}
...
} else {pstmtInsert_tDBOutput_1.setInt(3, output2.pages);
}

                        if(output2.author == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(4, output2.author);
}

                        if(output2.publisher == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(5, output2.publisher);
}
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)("/talendinfra/data/staging/books.csv") instanceof java.io.InputStream)){
...
System.out.println("Inserted Rows into books table:" + ((Integer)globalMap.get("tDBOutput_1_NB_LINE_INSERTED")));
System.out.println("Updated Rows into books table:" + ((Integer)globalMap.get("tDBOutput_1_NB_LINE_UPDATED")));
System.out.println("Rejected Rows into books table:" + ((Integer)globalMap.get("tDBOutput_1_NB_LINE_REJECTED")));
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.publisher = readString(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.author = readString(dis,objectIn);
					
						this.publisher = readString(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
					...
					writeInteger(this.pages, dos, oos);
						...
						writeString(this.publisher, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					writeInteger(this.pages, dos, objectOut);
						...
						writeString(this.author, dos, objectOut);
					
						writeString(this.publisher, dos, objectOut);
...
row6Struct row6 = new row6Struct();
	...
	currentComponent="tAdvancedHash_row6";
		...
		int tos_count_tAdvancedHash_row6 = 0;
			   		...
			   		// source node:tAddCRCRow_2 - inputs:(row5) outputs:(row6,row6) | target node:tAdvancedHash_row6 - inputs:(row6) outputs:()
...
+"";
            ...
            row5.id = rs_tDBInput_2.getInt(1);
        	...
        	row5.name = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, true);
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row5.pages = null;
							} else {
		                          
            row5.pages = rs_tDBInput_2.getInt(3);
            if(rs_tDBInput_2.wasNull()){
                    row5.pages = null;
            }
		                    }
        	...
        	row5.author = routines.system.JDBCUtil.getString(rs_tDBInput_2, 4, true);
		                    }
							if(colQtyInRs_tDBInput_2 < 5) {
								row5.publisher = null;
							} else {
	                         		
        	row5.publisher = routines.system.JDBCUtil.getString(rs_tDBInput_2, 5, true);
		                    }
       ...
       Long crcComputedValuetAddCRCRow_2 = null;
                StringBuilder strBuffer_tAddCRCRow_2 = new StringBuilder();
                       ...
                       strBuffer_tAddCRCRow_2.append(
				                ...
				                String.valueOf(row5.author)			
								
				);
                		
                       strBuffer_tAddCRCRow_2.append(
				
				                String.valueOf(row5.publisher)			
                    ...
                    crcComputedValuetAddCRCRow_2 = new Long(crc32tAddCRCRow_2.getValue());
                                ...
                                row6.author=row5.author;
                                row6.publisher=row5.publisher;
                            row6.CRC=crcComputedValuetAddCRCRow_2;
                                row6.id=row5.id;
                                row6.name=row5.name;
                                row6.pages=row5.pages;
                                row6.author=row5.author;
 ...
 */
	...
	currentComponent="tAdvancedHash_row6";
				...
				row6_HashRow.author = row6.author;
				
				row6_HashRow.publisher = row6.publisher;
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:P8XISzMIwqyVBEvpJzf/ryoFosnUWdvA/krn3BCfWpc=");
 ...
 */
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
		    ...
		    String dbquery_tDBInput_3 = "SELECT count(*) FROM INFORMATION_SCHEMA.TABLES\nwhere TABLE_NAME = 'books'";
            ...
            row7.FlagExistingTable = rs_tDBInput_3.getInt(1);
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    String dbquery_tDBInput_1 = "select nvl(max(id),0)+1 as MaxID from books";
            ...
            row4.MaxID = rs_tDBInput_1.getInt(1);
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("/talendinfra/data/staging/books.csv")).getAbsolutePath().replace("\\","/");
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, false),"UTF-8"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("author");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("publisher");
...
;
				...
				jsonPath_tFileInputJSON_1 = "pages";
				compiledJsonPath_tFileInputJSON_1 = jsonPathCache_tFileInputJSON_1.getCompiledJsonPath(jsonPath_tFileInputJSON_1);
				...
				try {
						...
						row1.pages = ParserUtils.parseTo_Integer(value_tFileInputJSON_1.toString());
						} else {
							row1.pages = 
...
;
				...
				jsonPath_tFileInputJSON_1 = "author";
				compiledJsonPath_tFileInputJSON_1 = jsonPathCache_tFileInputJSON_1.getCompiledJsonPath(jsonPath_tFileInputJSON_1);
				...
				try {
						...
						row1.author = value_tFileInputJSON_1 == null ? 
...
;
				...
				jsonPath_tFileInputJSON_1 = "publisher";
				compiledJsonPath_tFileInputJSON_1 = jsonPathCache_tFileInputJSON_1.getCompiledJsonPath(jsonPath_tFileInputJSON_1);
				...
				try {
						...
						row1.publisher = value_tFileInputJSON_1 == null ? 
...
output_tmp.pages = row1.pages ;
output_tmp.author = row1.author ;
output_tmp.publisher = row1.publisher ;
output = output_tmp;
} // closing filter/reject
// ###############################
 ...
 */
    ...
    public static void main(String[] args){
        final j_03_vendor_load_books j_03_vendor_load_booksClass = new j_03_vendor_load_books();

        int exitCode = j_03_vendor_load_booksClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = j_03_vendor_load_books.class.getClassLoader().getResourceAsStream("strider_de_assessment/j_03_vendor_load_books_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = j_03_vendor_load_books.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : j_03_vendor_load_books");
        }
...
/************************************************************************************************
 *     226195 characters generated by Talend Open Studio for Data Integration 
