...
package strider_de_assessment.j_05_vendor_move_processed_files_ftp_0_1;
...
/**
 * Job: j_05_vendor_move_processed_files_ftp Purpose: Job to move processed vendor files in FTP<br>
 * Description: Job to move processed vendor files in FTP <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class j_05_vendor_move_processed_files_ftp implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "j_05_vendor_move_processed_files_ftp";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				j_05_vendor_move_processed_files_ftp.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(j_05_vendor_move_processed_files_ftp.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
//check if the host is in the excludes for proxy
    ...
    for (String nonProxyHost : nonProxyHosts_tFTPConnection_1) {
        if (("127.0.0.1").matches(nonProxyHost.trim())) {
        ...
        String uriString = "127.0.0.1" + ":" + 990;
        ...
        ftp_tFTPConnection_1.connect("127.0.0.1",21);
 
	final String decryptedPassword_tFTPConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:nHEPsiNqKulCCoD2NVoW6JLW1dx2D+j/ZqECKDWLgFY=");

        boolean isLoginSuccessful_tFTPConnection_1 = ftp_tFTPConnection_1.login("root", decryptedPassword_tFTPConnection_1);
 ...
 */
    ...
    public static void main(String[] args){
        final j_05_vendor_move_processed_files_ftp j_05_vendor_move_processed_files_ftpClass = new j_05_vendor_move_processed_files_ftp();

        int exitCode = j_05_vendor_move_processed_files_ftpClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = j_05_vendor_move_processed_files_ftp.class.getClassLoader().getResourceAsStream("strider_de_assessment/j_05_vendor_move_processed_files_ftp_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = j_05_vendor_move_processed_files_ftp.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : j_05_vendor_move_processed_files_ftp");
        }
...
/************************************************************************************************
 *     94849 characters generated by Talend Open Studio for Data Integration 
