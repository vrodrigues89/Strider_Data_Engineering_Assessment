...
package strider_de_assessment.j_02_vendor_load_authors_0_1;
...
/**
 * Job: j_02_vendor_load_authors Purpose: Load data into authors table<br>
 * Description: Read vendor authors JSON file and load it to authors in MariaDB <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class j_02_vendor_load_authors implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "j_02_vendor_load_authors";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				j_02_vendor_load_authors.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(j_02_vendor_load_authors.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class output2Struct implements routines.system.IPersistableRow<output2Struct> {
    final static byte[] commonByteArrayLock_STRIDER_DE_ASSESSMENT_j_02_vendor_load_authors = new byte[0];
    static byte[] commonByteArray_STRIDER_DE_ASSESSMENT_j_02_vendor_load_authors = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_STRIDER_DE_ASSESSMENT_j_02_vendor_load_authors.length) {
				if(length < 1024 && commonByteArray_STRIDER_DE_ASSESSMENT_j_02_vendor_load_authors.length == 0) {
   					commonByteArray_STRIDER_DE_ASSESSMENT_j_02_vendor_load_authors = new byte[1024];
				} else {
   					commonByteArray_STRIDER_DE_ASSESSMENT_j_02_vendor_load_authors = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_STRIDER_DE_ASSESSMENT_j_02_vendor_load_authors, 0, length);
			strReturn = new String(commonByteArray_STRIDER_DE_ASSESSMENT_j_02_vendor_load_authors, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_STRIDER_DE_ASSESSMENT_j_02_vendor_load_authors, 0, length);
			strReturn = new String(commonByteArray_STRIDER_DE_ASSESSMENT_j_02_vendor_load_authors, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_STRIDER_DE_ASSESSMENT_j_02_vendor_load_authors) {
...
Var.v_id = Numeric.sequence("a1",(Integer)globalMap.get("MaxID"),1) ;
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:3LA/NRAPHo0Xt6+ScnVvhAaB1+myOAUshZN0Ou/brzE=");
 ...
 */
    ...
    public static void main(String[] args){
        final j_02_vendor_load_authors j_02_vendor_load_authorsClass = new j_02_vendor_load_authors();

        int exitCode = j_02_vendor_load_authorsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = j_02_vendor_load_authors.class.getClassLoader().getResourceAsStream("strider_de_assessment/j_02_vendor_load_authors_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = j_02_vendor_load_authors.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : j_02_vendor_load_authors");
        }
...
/************************************************************************************************
 *     236436 characters generated by Talend Open Studio for Data Integration 
