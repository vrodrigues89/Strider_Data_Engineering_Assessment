...
package strider_de_assessment.j_04_vendor_load_reviews_0_1;
...
/**
 * Job: j_04_vendor_load_reviews Purpose: Load data into reviews table<br>
 * Description: Read vendor authors JSON file and load it to reviews in MariaDB <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class j_04_vendor_load_reviews implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "j_04_vendor_load_reviews";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				j_04_vendor_load_reviews.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(j_04_vendor_load_reviews.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class output2Struct implements routines.system.IPersistableRow<output2Struct> {
    final static byte[] commonByteArrayLock_STRIDER_DE_ASSESSMENT_j_04_vendor_load_reviews = new byte[0];
    static byte[] commonByteArray_STRIDER_DE_ASSESSMENT_j_04_vendor_load_reviews = new byte[0];
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.movie == null) ? 0 : this.movie.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final output2Struct other = (output2Struct) obj;
						...
						} else if (!this.movie.equals(other.movie))
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_STRIDER_DE_ASSESSMENT_j_04_vendor_load_reviews.length) {
				if(length < 1024 && commonByteArray_STRIDER_DE_ASSESSMENT_j_04_vendor_load_reviews.length == 0) {
   					commonByteArray_STRIDER_DE_ASSESSMENT_j_04_vendor_load_reviews = new byte[1024];
				} else {
   					commonByteArray_STRIDER_DE_ASSESSMENT_j_04_vendor_load_reviews = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_STRIDER_DE_ASSESSMENT_j_04_vendor_load_reviews, 0, length);
			strReturn = new String(commonByteArray_STRIDER_DE_ASSESSMENT_j_04_vendor_load_reviews, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_STRIDER_DE_ASSESSMENT_j_04_vendor_load_reviews, 0, length);
			strReturn = new String(commonByteArray_STRIDER_DE_ASSESSMENT_j_04_vendor_load_reviews, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_STRIDER_DE_ASSESSMENT_j_04_vendor_load_reviews) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.review = readString(dis);
						...
						this.rate = readInteger(dis);
					
					this.book = readString(dis);
					
						this.pages = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.rate,dos);
					
					// String
				
						writeString(this.book,dos);
					
					// Integer
				
						writeInteger(this.pages,dos);
    ...
    public String toString() {
		...
		sb.append(",book="+book);
		sb.append(",pages="+String.valueOf(pages));
    ...
    public int compareTo(output2Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.review, other.review);
						if(returnValue != 0) {
							return returnValue;
						}

					
						returnValue = checkNullsAndCompare(this.rate, other.rate);
						if(returnValue != 0) {
							return returnValue;
						}

					
						returnValue = checkNullsAndCompare(this.book, other.book);
						if(returnValue != 0) {
							return returnValue;
						}

					
						returnValue = checkNullsAndCompare(this.movie, other.movie);
						if(returnValue != 0) {
							return returnValue;
						}
...
String tableName_tDBOutput_1 = "reviews";
...
int count_tDBOutput_1=0;
                                ...
                                while(rsTable_tDBOutput_1.next()) {
                                    ...
                                    if(table_tDBOutput_1.equalsIgnoreCase("reviews")) {
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1 + "`(`id` INT(0)  ,`review` VARCHAR(0)  ,`rate` INT(0)  ,`book` VARCHAR(0)  ,`pages` INT(0)  ,`movie` VARCHAR(0)  ,`updated` VARCHAR(0)  ,`created` VARCHAR(0)  ,primary key(`review`,`rate`,`book`,`movie`))");
                                    }
                                }
	    java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM `" + "reviews" + "` WHERE `review` = ? AND `rate` = ? AND `book` = ? AND `movie` = ?");
	    resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO `" + "reviews" + "` (`id`,`review`,`rate`,`book`,`pages`,`movie`,`updated`,`created`) VALUES (?,?,?,?,?,?,?,?)";
	        
	    java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
	    resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
	    String update_tDBOutput_1 = "UPDATE `" + "reviews" + "` SET `id` = ?,`pages` = ?,`updated` = ?,`created` = ? WHERE `review` = ? AND `rate` = ? AND `book` = ? AND `movie` = ?";
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "/talendinfra/data/staging/reviews.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("/talendinfra/data/staging/reviews.csv", "UTF-8",";","\n",true,1,0,
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",e.getMessage());
				...
				int columnIndexWithD_tFileInputDelimited_1 = 0;
					...
					columnIndexWithD_tFileInputDelimited_1 = 0;
							...
							row2.review = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
					...
					columnIndexWithD_tFileInputDelimited_1 = 1;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row2.rate = ParserUtils.parseTo_Integer(temp);
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"rate", "row2", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 2;
							...
							row2.book = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 3;
					
							row2.pages = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 4;
					
							row2.movie = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 5;
					
							row2.updated = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 6;
					
							row2.created = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
...
// # Output table : 'out'
out_tmp.review = row2.review ;
out_tmp.rate = row2.rate ;
out_tmp.book = row2.book ;
out_tmp.pages = row2.pages.equals("") ? null : Integer.parseInt(row2.pages) ;
out_tmp.movie = row2.movie ;
out_tmp.updated = row2.updated.equals("") ? null : row2.updated ;
out_tmp.created = row2.created.equals("") ? null : row2.created ;
out = out_tmp;
// ###############################
       ...
       Long crcComputedValuetAddCRCRow_2 = null;
                StringBuilder strBuffer_tAddCRCRow_2 = new StringBuilder();
                       strBuffer_tAddCRCRow_2.append(
				                ...
				                String.valueOf(out.pages)			
								
				);
                		
                       strBuffer_tAddCRCRow_2.append(
				
				                String.valueOf(out.updated)			
								
				);
                		
                       strBuffer_tAddCRCRow_2.append(
				
				                String.valueOf(out.created)			
                    ...
                    crcComputedValuetAddCRCRow_2 = new Long(crc32tAddCRCRow_2.getValue());
                                row3.review=out.review;
                                row3.rate=out.rate;
                                row3.book=out.book;
                                row3.pages=out.pages;
                                row3.movie=out.movie;
                                row3.updated=out.updated;
                                row3.created=out.created;
 					    ...
 					    boolean forceLooprow6 = false;
 							...
 							row6Struct row6ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		    ...
                        		    		    row6HashKey.review = row3.review ;
                        		    		
                        		    		    row6HashKey.rate = row3.rate ;
                        		    		
                        		    		    row6HashKey.book = row3.book ;
                        		    		
                        		    		    row6HashKey.movie = row3.movie ;
				           		...
				           		if(tHash_Lookup_row6 != null && tHash_Lookup_row6.getCount(row6HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row6' and it contains more one result from keys :  row6.review = '" + row6HashKey.review + "', row6.rate = '" + row6HashKey.rate + "', row6.book = '" + row6HashKey.book + "', row6.movie = '" + row6HashKey.movie + "'");
								} // G 071
...
Var.v_id = Numeric.sequence("r1",(Integer)globalMap.get("MaxID"),1) ;
...
output2_tmp.review = row3.review ;
output2_tmp.rate = row3.rate ;
output2_tmp.book = row3.book ;
output2_tmp.pages = row3.pages ;
output2_tmp.movie = row3.movie ;
output2_tmp.updated = row3.updated ;
output2_tmp.created = row3.created ;
output2 = output2_tmp;
...
if(output2 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(output2.review == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, output2.review);
}

                    if(output2.rate == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(2, output2.rate);
}

                    if(output2.book == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, output2.book);
}

                    if(output2.movie == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, output2.movie);
}
...
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
                        ...
                        if(output2.pages == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(2, output2.pages);
}

                        if(output2.updated == null) {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(3, output2.updated);
}

                        if(output2.created == null) {
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4, output2.created);
}

                        if(output2.review == null) {
pstmtUpdate_tDBOutput_1.setNull(5 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(5 + count_tDBOutput_1, output2.review);
}

                        if(output2.rate == null) {
pstmtUpdate_tDBOutput_1.setNull(6 + count_tDBOutput_1, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(6 + count_tDBOutput_1, output2.rate);
}

                        if(output2.book == null) {
pstmtUpdate_tDBOutput_1.setNull(7 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(7 + count_tDBOutput_1, output2.book);
}

                        if(output2.movie == null) {
pstmtUpdate_tDBOutput_1.setNull(8 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(8 + count_tDBOutput_1, output2.movie);
}
...
} else {pstmtInsert_tDBOutput_1.setString(2, output2.review);
}

                        if(output2.rate == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(3, output2.rate);
}

                        if(output2.book == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(4, output2.book);
}

                        if(output2.pages == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(5, output2.pages);
}

                        if(output2.movie == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(6, output2.movie);
}

                        if(output2.updated == null) {
pstmtInsert_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(7, output2.updated);
}

                        if(output2.created == null) {
pstmtInsert_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(8, output2.created);
}
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)("/talendinfra/data/staging/reviews.csv") instanceof java.io.InputStream)){
...
System.out.println("Inserted Rows into reviews table:" + ((Integer)globalMap.get("tDBOutput_1_NB_LINE_INSERTED")));
System.out.println("Updated Rows into reviews table:" + ((Integer)globalMap.get("tDBOutput_1_NB_LINE_UPDATED")));
System.out.println("Rejected Rows into reviews table:" + ((Integer)globalMap.get("tDBOutput_1_NB_LINE_REJECTED")));
...
public static class row6Struct implements routines.system.IPersistableComparableLookupRow<row6Struct> {
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.pages = readInteger(dis,ois);
					
						this.updated = readString(dis,ois);
					
						this.created = readString(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.pages = readInteger(dis,objectIn);
					
						this.updated = readString(dis,objectIn);
					
						this.created = readString(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
					...
					writeInteger(this.pages, dos, oos);
					
						writeString(this.updated, dos, oos);
					
						writeString(this.created, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					writeInteger(this.pages, dos, objectOut);
					
						writeString(this.updated, dos, objectOut);
					
						writeString(this.created, dos, objectOut);
...
+"AT(created, '%Y-%m-%d %T') AS created\nFROM `data`.reviews;\n";
        	...
        	row5.review = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 3) {
								row5.rate = null;
							} else {
		                          
            row5.rate = rs_tDBInput_3.getInt(3);
            if(rs_tDBInput_3.wasNull()){
                    row5.rate = null;
            }
		                    }
        	...
        	row5.book = routines.system.JDBCUtil.getString(rs_tDBInput_3, 4, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 5) {
								row5.pages = null;
							} else {
		                          
            row5.pages = rs_tDBInput_3.getInt(5);
            if(rs_tDBInput_3.wasNull()){
                    row5.pages = null;
            }
		                    }
        	...
        	row5.movie = routines.system.JDBCUtil.getString(rs_tDBInput_3, 6, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 7) {
								row5.updated = null;
							} else {
	                         		
        	row5.updated = routines.system.JDBCUtil.getString(rs_tDBInput_3, 7, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 8) {
								row5.created = null;
							} else {
	                         		
        	row5.created = routines.system.JDBCUtil.getString(rs_tDBInput_3, 8, true);
		                    }
       ...
       Long crcComputedValuetAddCRCRow_1 = null;
                StringBuilder strBuffer_tAddCRCRow_1 = new StringBuilder();
                       strBuffer_tAddCRCRow_1.append(
				                ...
				                String.valueOf(row5.pages)			
								
				);
                		
                       strBuffer_tAddCRCRow_1.append(
				
				                String.valueOf(row5.updated)			
								
				);
                		
                       strBuffer_tAddCRCRow_1.append(
				
				                String.valueOf(row5.created)			
                    ...
                    crcComputedValuetAddCRCRow_1 = new Long(crc32tAddCRCRow_1.getValue());
                                row6.id=row5.id;
                                row6.review=row5.review;
                                row6.rate=row5.rate;
                                row6.book=row5.book;
                                row6.pages=row5.pages;
                                row6.movie=row5.movie;
                                row6.updated=row5.updated;
                                row6.created=row5.created;
 ...
 */
	...
	currentComponent="tAdvancedHash_row6";
				...
				row6_HashRow.review = row6.review;
				
				row6_HashRow.rate = row6.rate;
				
				row6_HashRow.book = row6.book;
				
				row6_HashRow.pages = row6.pages;
				
				row6_HashRow.movie = row6.movie;
				
				row6_HashRow.updated = row6.updated;
				
				row6_HashRow.created = row6.created;
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:K/tFsBvoP8zNmeC8SBfSOGmv+afmu+wfF87XCejfg1Q=");
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
		    ...
		    String dbquery_tDBInput_2 = "select nvl(max(id),0)+1 as MaxID from reviews";
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("/talendinfra/data/staging/reviews.csv")).getAbsolutePath().replace("\\","/");
                    ...
                    if(directory_tFileOutputDelimited_1 != null && directory_tFileOutputDelimited_1.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, false),"UTF-8"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        outtFileOutputDelimited_1.write("review");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("rate");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("book");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("pages");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("movie");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("updated");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
...
for(Object row_tFileInputJSON_1 : resultset_tFileInputJSON_1) {
	...
	try{
				jsonPath_tFileInputJSON_1 = "content.text";
				...
				try {
						...
						row1.review = value_tFileInputJSON_1 == null ? 
...
;
				...
				jsonPath_tFileInputJSON_1 = "rating.rate";
				compiledJsonPath_tFileInputJSON_1 = jsonPathCache_tFileInputJSON_1.getCompiledJsonPath(jsonPath_tFileInputJSON_1);
				...
				try {
						...
						row1.rate = ParserUtils.parseTo_Integer(value_tFileInputJSON_1.toString());
						} else {
							row1.rate = 
...
;
				...
				jsonPath_tFileInputJSON_1 = "books[*].metadata.title";
				compiledJsonPath_tFileInputJSON_1 = jsonPathCache_tFileInputJSON_1.getCompiledJsonPath(jsonPath_tFileInputJSON_1);
				...
				try {
						...
						row1.book = value_tFileInputJSON_1 == null ? 
...
;
				...
				jsonPath_tFileInputJSON_1 = "books[*].metadata.pages";
				compiledJsonPath_tFileInputJSON_1 = jsonPathCache_tFileInputJSON_1.getCompiledJsonPath(jsonPath_tFileInputJSON_1);
				...
				try {
						...
						row1.pages = value_tFileInputJSON_1 == null ? 
...
;
				...
				jsonPath_tFileInputJSON_1 = "movies[*].title";
				compiledJsonPath_tFileInputJSON_1 = jsonPathCache_tFileInputJSON_1.getCompiledJsonPath(jsonPath_tFileInputJSON_1);
				...
				try {
						...
						row1.movie = value_tFileInputJSON_1 == null ? 
...
;
				...
				jsonPath_tFileInputJSON_1 = "updated";
				compiledJsonPath_tFileInputJSON_1 = jsonPathCache_tFileInputJSON_1.getCompiledJsonPath(jsonPath_tFileInputJSON_1);
				...
				try {
						...
						row1.updated = value_tFileInputJSON_1 == null ? 
...
;
				...
				jsonPath_tFileInputJSON_1 = "created";
				compiledJsonPath_tFileInputJSON_1 = jsonPathCache_tFileInputJSON_1.getCompiledJsonPath(jsonPath_tFileInputJSON_1);
				...
				try {
						...
						row1.created = value_tFileInputJSON_1 == null ? 
...
output_tmp.review = row1.review ;
output_tmp.rate = row1.rate ;
output_tmp.book = row1.book.replaceAll("[\"',]", "").replaceAll("\\[", "").replaceAll("\\]", "") ;
output_tmp.pages = row1.pages.replaceAll("[\"',]", "").replaceAll("\\[", "").replaceAll("\\]", "").replaceAll("unknown", "") ;
output_tmp.movie = row1.movie.replaceAll("[\"',]", "").replaceAll("\\[", "").replaceAll("\\]", "").replaceAll("end", "") ;
output_tmp.updated = row1.updated == null || row1.updated == "" ? null :
TalendDate.formatDate("yyyy-MM-dd HH:mm:ss",TalendDate.parseDate("yyyy-MM-dd'T'HH:mm:ss.SSSZ",row1.updated)) ;
output_tmp.created = row1.created == null || row1.created == "" ? null :
TalendDate.formatDate("yyyy-MM-dd HH:mm:ss",TalendDate.parseDate("yyyy-MM-dd'T'HH:mm:ss.SSSZ",row1.created)) ;
output = output_tmp;
} // closing filter/reject
// ###############################
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(output.movie != null) {
                        sb_tFileOutputDelimited_1.append(
                            output.movie
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(output.updated != null) {
                        sb_tFileOutputDelimited_1.append(
                            output.updated
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(output.created != null) {
                        sb_tFileOutputDelimited_1.append(
                            output.created
                        );
                            }
 ...
 */
    ...
    public static void main(String[] args){
        final j_04_vendor_load_reviews j_04_vendor_load_reviewsClass = new j_04_vendor_load_reviews();

        int exitCode = j_04_vendor_load_reviewsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = j_04_vendor_load_reviews.class.getClassLoader().getResourceAsStream("strider_de_assessment/j_04_vendor_load_reviews_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = j_04_vendor_load_reviews.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : j_04_vendor_load_reviews");
        }
...
/************************************************************************************************
 *     262203 characters generated by Talend Open Studio for Data Integration 
